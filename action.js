...
function getPokemon() {
  ...
  let pokemonNumber = getRandomInt(pokemonData.length); //get a random number
  console.log("🚀 ~ file: action.js:67 ~ getPokemon ~ pokemonNumber:", pokemonNumber)
